EECS 348: Software Engineering - Spring 2025

Lab #5: IDE, compiled programs (C programming), Git

Objective: Get familiar with the IDE and C programming (using arrays) and practice Git again. During the C programming, you will practice the basic file operations, array manipulation, functional calls, and output format control.

Due Date: Sunday, March 8, 2026, at 11:59 p.m.
...
Please note that both programs must include their corresponding Makefiles. You may create two separate folders and place each program’s source code and Makefile in its own folder. Do not submit any executable files.
